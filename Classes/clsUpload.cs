...
namespace API_WEB_INMOBILIARIA.Classes
{
    public class clsUpload
    {
        ...
        private string ProcesarArchivos(List<string> Archivos)
        {
            ...
            {
                case "PROPIEDAD":
                    clsImagenesPropiedad imagenesPropiedad = new clsImagenesPropiedad();
                    imagenesPropiedad.id_propiedad = Datos;
                    imagenesPropiedad.Archivos = Archivos;
                    return imagenesPropiedad.GrabarImagenes();
                default:
